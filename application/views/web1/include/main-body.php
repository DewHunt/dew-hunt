                            ...
                            <div class="container">
                                <div class="navbar-header page-scroll">
                                    ...
                                    <div class="navbar-brand">
                                        <a class="logo-black" href="index.html"><img src="<?= base_url(); ?>assets/web1/images/logo.png" alt="">
                                        </a>
                                        <a class="logo-white" href="index.html"><img src="<?= base_url(); ?>assets/web1/images/logo-white.png" alt="">
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="welcome-col">
                            <img src="<?= base_url(); ?>assets/web1/images/about/1.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-col col-default">
                            <h2>My Skills</h2>
                            <h5>With more than 10 years of experience</h5>
                            <!-- Progress Bar Start -->
                            <div class="progress-box">
                                <h5>HTML5 <span class="color-heading pull-right">88%</span></h5>
                                <div class="progress">
                        ...
                        <div class="filtr-container">
                            <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 2" data-sort="value">
                                <div class="portfolio-item">
                                    <img src="<?= base_url(); ?>assets/web1/images/portfolio/1.jpg" class="img-responsive" alt="portfolio">
                                    <div class="portfolio-item-info">
                                        <div class="item-caption">
                                            <ul>
                                                <li>
                                                    <a href="images/portfolio/1.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="2, 1" data-sort="value">
                                <div class="portfolio-item">
                                    <img src="<?= base_url(); ?>assets/web1/images/portfolio/2.jpg" class="img-responsive" alt="portfolio">
                                    <div class="portfolio-item-info">
                                        <div class="item-caption">
                                            <ul>
                                                <li>
                                                    <a href="images/portfolio/2.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </li>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 1" data-sort="value">
                                <div class="portfolio-item">
                                    <img src="<?= base_url(); ?>assets/web1/images/portfolio/3.jpg" class="img-responsive" alt="portfolio">
                                    <div class="portfolio-item-info">
                                        <div class="item-caption">
                                            <ul>
                                                <li>
                                                    <a href="images/portfolio/3.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </li>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="1, 2" data-sort="value">
                                <div class="portfolio-item">
                                    <img src="<?= base_url(); ?>assets/web1/images/portfolio/4.jpg" class="img-responsive" alt="portfolio">
                                    <div class="portfolio-item-info">
                                        <div class="item-caption">
                                            <ul>
                                                <li>
                                                    <a href="images/portfolio/4.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </li>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 2" data-sort="value">
                                <div class="portfolio-item">
                                    <img src="<?= base_url(); ?>assets/web1/images/portfolio/5.jpg" class="img-responsive" alt="portfolio">
                                    <div class="portfolio-item-info">
                                        <div class="item-caption">
                                            <ul>
                                                <li>
                                                    <a href="images/portfolio/5.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </li>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="3, 1" data-sort="value">
                                <div class="portfolio-item">
                                    <img src="<?= base_url(); ?>assets/web1/images/portfolio/6.jpg" class="img-responsive" alt="portfolio">
                                    <div class="portfolio-item-info">
                                        <div class="item-caption">
                                            <ul>
                                                <li>
                                                    <a href="images/portfolio/6.jpg" data-lightbox="lightbox" data-title="my project title"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                                </li>
                    ...
                    <div class="col-md-12">
                        <div class="testimonial-carousel" data-slick='{"slidesToShow": 2, "slidesToScroll": 1}'>
                            <div class="testimonial-item">
                                <div class="testimonial-item-content">
                                    <div class="testimonial-img">
                                        <img src="<?= base_url(); ?>assets/web1/images/testimonial/1.jpg" alt="">
                                    </div>
                            ...
                            <div class="testimonial-item">
                                <div class="testimonial-item-content">
                                    <div class="testimonial-img">
                                        <img src="<?= base_url(); ?>assets/web1/images/testimonial/2.jpg" alt="">
                                    </div>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                    <h4>Nelson Elvina</h4>
                                    <span>CEO, Envato</span>
                            ...
                            <div class="testimonial-item">
                                <div class="testimonial-item-content">
                                    <div class="testimonial-img">
                                        <img src="<?= base_url(); ?>assets/web1/images/testimonial/3.jpg" alt="">
                                    </div>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                    <h4>Nil Mardana</h4>
                                    <span>CEO, Envato</span>
                    ...
                    <div class="col-md-12">
                        <div class="blog-carousel" data-slick='{"slidesToShow": 3, "slidesToScroll": 1}'> 
                            <div class="blog-slide">                            
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/web1/images/blog/1.jpg" alt="">
                                    <a href="blog-details.html" class="read">read more</a>
                                </div>
                                <div class="blog-content">
                                    <span class="blog-author">
                                        <a href="#"><img src="<?= base_url(); ?>assets/web1/images/blog/post-1.jpg" alt=""></a>
                                    </span>
                                    <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                    <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                                </div>
                                <ul class="blog-info">
                            ...
                            <div class="blog-slide">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/web1/images/blog/2.jpg" alt="">
                                    <a href="blog-details.html" class="read">read more</a>
                                </div>
                                <div class="blog-content">
                                    <span class="blog-author">
                                        <a href="#"><img src="<?= base_url(); ?>assets/web1/images/blog/post-2.jpg" alt=""></a>
                                    </span>
                                    <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                    <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                                </div>
                            ...
                            <div class="blog-slide">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/web1/images/blog/3.jpg" alt="">
                                    <a href="blog-details.html" class="read">read more</a>
                                </div>
                                <div class="blog-content">
                                    <span class="blog-author">
                                        <a href="#"><img src="<?= base_url(); ?>assets/web1/images/blog/post-3.jpg" alt=""></a>
                                    </span>
                                    <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                    <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                                </div>
                            ...
                            <div class="blog-slide">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/web1/images/blog/4.jpg" alt="">
                                    <a href="blog-details.html" class="read">read more</a>
                                </div>
                                <div class="blog-content">
                                    <span class="blog-author">
                                        <a href="#"><img src="<?= base_url(); ?>assets/web1/images/blog/post-4.jpg" alt=""></a>
                                    </span>
                                    <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                    <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                                </div>
                            ...
                            <div class="blog-slide">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/web1/images/blog/5.jpg" alt="">
                                    <a href="blog-details.html" class="read">read more</a>
                                </div>
                                <div class="blog-content">
                                    <span class="blog-author">
                                        <a href="#"><img src="<?= base_url(); ?>assets/web1/images/blog/post-5.jpg" alt=""></a>
                                    </span>
                                    <h3><a href="blog-details.html">Here is the Post title</a></h3>
                                    <p class="blog-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected.</p>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="col-default">
                            <div class="row">
                                ...
                                <form id="ajax-contact" method="post" action="http://rajibweb.com/html/collis/php/contact.php">
                                    <div class="col-md-6">
